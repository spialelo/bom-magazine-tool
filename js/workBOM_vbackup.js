...
$(function(){
    ...
    $("#generate").on("click", function(){
        ...
        $.each(storiesInput, function(index, value) {

           return "\<table align=\"left\" width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"\>\<tr\>\<td style=\"font-size:14px; font-family:Arial, Helvetica, sans-serif; color: #000000;\"\>\<a style=\"color:#0b486c; text-decoration:none; font-weight:bold;\" href=\"http:\/\/www.medscape.com\/viewarticle\/849989\?src=wnl_edit_bom_weekly&uac=%%uac%%&impID=%%JOBID%%&faf=1\"\>How Many Hearts Should One Child Receive?\<\/a\>\<\/td\>\<\/tr\>\<tr\>\<td height=\"15\" valign=\"top\" style=\"font-size:1px; line-height:15px;\"\>\<img style=\"display:block;\" height=\"1\" src=\"http:\/\/img.medscapestatic.com\/pi\/global\/ornaments\/spacer.gif\" width=\"1\" border=\"0\" alt=\"\"\>\<\/td\> \<\/tr\>\<\/table\>";
...
var displayEditorsNote = editorsNote;
    ...
    $("#displayContent").html(displayStories + displayNews + displayBlogs + displayEditorsNote);
